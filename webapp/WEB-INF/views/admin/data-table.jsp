...
<%--                                                <td><button class="btn btn-primary" onclick="window.open=''">이미지 보기</button></td>--%>
                                            </c:otherwise>
                                            </c:choose>
                                            <td>
                                                <button class="btn btn-primary" onclick="location.href='/admin/edit.do?lecNo=${lectureList[i-1].lecNo}'">수정</button>
                                                <button class="btn btn-primary" onclick="if(confirm('정말 삭제하시겠습니까?')){location.href='/admin/delete.do?lecNo=${lectureList[i-1].lecNo}';} else {return false;}">삭제</button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
