                        ...
                        <div class="card-body">
                            ...
                            <form action="/admin/editLecture.do?lecNo=${lecture.lecNo}" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputText1" placeholder="Lecture Category" name="lecCategory" value="${lecture.lecCategory}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputText2">NAME</label>
                                    <input type="text" class="form-control" id="exampleInputText2" placeholder="Lecture Name" name="lecName" value="${lecture.lecName}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputNumber1">PRICE</label>
                                    <input type="number" class="form-control" id="exampleInputNumber1" placeholder="Price" name="lecPrice" value="${lecture.lecPrice}">
                                </div>

                                <div class="form-group">
                                    <label>File upload</label>
                                    <input type="file" name="lecImg" class="file-upload-default">
                                    <div class="input-group col-xs-12">
                                        <c:set var="lecimg" value="${lecture.lecImg.substring(9)}"/>
                                ...
                                <button class="btn btn-primary" onclick="location.href='admin/data-table.do'">취소</button>
                            </form>
                        </div>
                    </div>
                </div>
