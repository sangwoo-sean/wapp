                        ...
                        <div class="card-body">
                            ...
                            <form action="/admin/addLecture.do" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputText1" placeholder="Lecture Category" name="lecCategory">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputText2">NAME</label>
                                    <input type="text" class="form-control" id="exampleInputText2" placeholder="Lecture Name" name="lecName">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputNumber1">PRICE</label>
                                    <input type="number" class="form-control" id="exampleInputNumber1" placeholder="Price" name="lecPrice">
                                </div>
